    ...
    <main className="hero-bg mystic-page min-h-screen p-4 md:p-8">
      <section className="mx-auto max-w-5xl">
        <div className="mb-5 flex flex-wrap items-end justify-between gap-3">
          <div>
            <p className="mystic-pill">MASTER REPORT</p>
            <h1 className="mystic-title mt-2 text-3xl">推演报告</h1>
          </div>
          <button className="mystic-ghost-btn" onClick={() => router.push("/")}>
            返回首页
          </button>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
          <aside className="mystic-panel animate-rise">
            ...
            <div className="mt-4 rounded-2xl border border-slate-200 bg-white/90 p-4">
              <p className="mystic-section-title">卦象结构</p>
          ...
          <section className="mystic-panel animate-rise delay-1">
            {isPaid ? (
              ...
              <div className="rounded-2xl border border-slate-200 bg-white/95 p-6">
                ...
                <button onClick={() => router.push("/")} className="mystic-ghost-btn ml-3">
                  返回修改
                </button>
              </div>
            )}
